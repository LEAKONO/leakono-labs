        ...
        >
          {FILTERS.map((f) => {
            const color =
              f.value === 'all'
                ? '#00d4ff'
                : GROUP_COLORS[f.value as TechNode['group']];
            return (
              <button
                key={f.value}
                ...
                style={{
                  ...
                  color: activeGroup === f.value ? color : '#6e7681',
                }}
              >
                {f.label}
              </button>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <h4 className="text-white font-600 text-sm mt-2">
                        {node.label}
                      </h4>
                    </div>
                    <div
                      className="font-mono text-2xl font-black opacity-10
                      ...
                      {node.connections.slice(0, 4).map((connId) => {
                        ...
                        return (
                          <span
                            ...
                            style={{
                              background: `${GROUP_COLORS[connNode.group]}10`,
                              color: `${GROUP_COLORS[connNode.group]}90`,
                              border: `1px solid ${GROUP_COLORS[connNode.group]}20`,
                            }}
                          >
                            {connNode.label}
                          </span>
